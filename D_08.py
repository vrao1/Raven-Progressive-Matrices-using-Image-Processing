...
def mainD08(problem):
	...
	#image D	
	im1 = Image.open(problem.figures["D"].visualFilename)
	im1 = im1.convert("L")
	...
	#image E
	im2 = Image.open(problem.figures["E"].visualFilename)
	im2 = im2.convert("L")
	...
	#image F	
	im3 = Image.open(problem.figures["F"].visualFilename)
	im3 = im3.convert("L")
	...
	sampleShadedImageList.append(im7_shaded)
	#im7_shaded.show()
	...
	sampleContourImageList.append(im7_contour)
	#im7_contour.show()
	...
	sampleShadedImageList.append(im8_shaded)
	#im8_shaded.show()
	...
	sampleContourImageList.append(im8_contour)
	#im8_contour.show()
